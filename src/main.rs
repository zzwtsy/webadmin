                        ...
                        <ProtectedRoute
                            ...
                            condition=move || {
                                permissions
                                    ...
                                    .map_or(
                                        false,
                                        |p| { p.has_access(Permission::MessageQueueList) },
                                    )
                            }
                        />
                        ...
                        <ProtectedRoute
                            ...
                            condition=move || {
                                permissions
                                    ...
                                    .map_or(
                                        false,
                                        |p| { p.has_access(Permission::MessageQueueGet) },
                                    )
                            }
                        />
                        ...
                        <ProtectedRoute
                            ...
                            condition=move || {
                                permissions
                                    ...
                                    .map_or(
                                        false,
                                        |p| { p.has_access(Permission::OutgoingReportList) },
                                    )
                            }
                        />
                        ...
                        <ProtectedRoute
                            ...
                            condition=move || {
                                permissions
                                    ...
                                    .map_or(
                                        false,
                                        |p| { p.has_access(Permission::OutgoingReportGet) },
                                    )
                            }
                        />
                        ...
                        <ProtectedRoute
                            ...
                            condition=move || {
                                permissions
                                    ...
                                    .map_or(
                                        false,
                                        |p| { p.has_access(Permission::IncomingReportList) },
                                    )
                            }
                        />
                        ...
                        <ProtectedRoute
                            ...
                            condition=move || {
                                permissions
                                    ...
                                    .map_or(
                                        false,
                                        |p| { p.has_access(Permission::IncomingReportGet) },
                                    )
                            }
                        />
                        ...
                        <ProtectedRoute
                            ...
                            condition=move || {
                                permissions
                                    ...
                                    .map_or(
                                        false,
                                        |p| { p.has_access(Permission::ManageEncryption) },
                                    )
                            }
                        />
                        ...
                        <ProtectedRoute
                            ...
                            condition=move || {
                                permissions
                                    ...
                                    .map_or(
                                        false,
                                        |p| { p.has_access(Permission::ManagePasswords) },
                                    )
                            }
                        />
